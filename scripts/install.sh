...
for f in clients.yaml tokens.yaml frontier.yaml fallback.yaml routing.yaml eviction.yaml notifications.yaml logging.yaml guardrails.yaml fail2ban.yaml pricing.yaml splunk.yaml; do
